...
The estimate the treatment effect via inverse propensity score weighting is 1657.51 using the first specification and 1440.64 using the second specification with additional covariates added to the estimation of the propensity score.
