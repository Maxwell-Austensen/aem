...
It is true that among all the schools there is a negative and significant effect of a winning vote for GM and baseline pass rates, however this effect is not significant among subsamples that exclude schools with voteshares furthest from the cutoff. It is still somewhat concerning that even though the estimates are not significant, the sign remains negative in all subsamples considered above including the Imbens-Kalyanaraman optimal bandwidth used in the local linear models.
